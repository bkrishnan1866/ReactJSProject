  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <select name="id_weaver" ref={register} onChange={onSelect}>
        ...
        <select name="id_saree_type" ref={register} onChange={onSelect}>
        ...
        <label>Status : </label>
        <select name="id_status_id" ref={register} onChange={onSelect}>
